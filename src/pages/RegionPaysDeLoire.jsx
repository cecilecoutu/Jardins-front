...
function RegionPaysDeLoire(props) {
  ...
  // Filtrer les jardins de la région Pays de la Loire
  const jardinsPaysDeLoire = jardins.filter(
    (jardin) => jardin.fields.region === "Pays de la Loire"
  );

  return (
    <div style={styles.titleContainer}>
      <h1>Les jardins remarquables en région Pays de Loire</h1>
      <ul>
...
export default RegionPaysDeLoire;
