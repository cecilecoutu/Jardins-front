...
function RegionBretagne(props) {
  ...
  // Filtrer les jardins de la région Bretagne
  const jardinsBretagne = jardins.filter(
    (jardin) => jardin.fields.region === "Bretagne"
  );
