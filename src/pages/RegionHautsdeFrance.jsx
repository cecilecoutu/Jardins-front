...
function RegionHautsdeFrance(props) {
  ...
  const [regionFiltre, setRegionFiltre] = useState("Hauts-de-France");
  ...
  // Filtrer les jardins de la région Hauts-de-France
  const jardinsHautsDeFrance = jardins.filter(
    (jardin) => jardin.fields.region === "Hauts-de-France"
  );

  return (
    <div>
      <h1>Les jardins remarquales en région Hauts-de-France</h1>
      <ul>
        {jardinsHautsDeFrance.map((jardin) => (
